...
<div class="container">
        ...
        <div class="col-md-1"></div>
            <div class="col-md-4">
                <div class="card ">
                    <div class="card-header bg-warning text-white">Available to Unavailable
                    ...
                    <div class="card-body">
                        <form ng-app="disable" action="additem_status_process.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><input type="submit" value="Confirm Unavailable" name="disable" class="btn btn-warning btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="additem_status_process.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><input type="submit" value="Confirm Available" name="able"class="btn btn-info btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
