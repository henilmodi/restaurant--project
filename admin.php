                    ...
                    <div class="card-body">
                        <form action="addto_waiting.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><input type="submit" value="Add" class="btn btn-warning btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="assign_table.php" method="POST">
                            ...
                            <td><select name="no" class="form-control">
                                ...
                                <tr>
                                    <td><input type="submit" value="Assign" class="btn btn-success btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="remove.php" method="POST">
                            ...
                            <td><select name="no" class="form-control">
                                ...
                                <tr>
                                    <td><input type="submit" value="Remove Name" name="delete" class="btn btn-danger btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
