                    ...
                    <div class="card-body">
                        <form action="category_status_process.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><input type="submit" value="Confirm Unavailable" name="disable" class="btn btn-danger btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="category_status_process.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><input type="submit" value="Confirm Available" name="able"class="btn btn-success btn-full" style="width: 100%;"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
